    ...
    return (
        <section id='about' className='my-12'>
            <div className='flex justify-center'>
                <div className="relative w-[80%] h-[28rem] overflow-hidden rounded-[1rem]">
                    ...
                    <div className='absolute top-44 left-20 flex flex-col gap-6'>
                        ...
                        <h1 className='font-[400] text-white text-[38px] leading-[41.8px]'>Lorem ipsum dolor sit amet.</h1>
                        <div>
            ...
            <div className='flex justify-center  items-center my-6'>
                <div className='w-[823px] h-[534px] px-16'>
                    <h1 className='font-[400] text-[54px] leading-[72.9px]'>Lorem ipsum dolor sit amet, consectetur </h1>
                    <p className='font-[400] text-[20px] leading-[34px]'>
                ...
                <div className='w-[590px] h-[429px] flex flex-col gap-16 px-5'>
                    <div className='border-l-4 px-8 border-black'>
                        <h3 className='font-[400] text-[26px] leading-[37.18px]'>Lorem ipsum</h3>
                        <p className='text-[18px] leading-[25.74px] font-[400]'>
