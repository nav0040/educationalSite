...
const CompanyDetails = () => {
    return (
        <section id='company' className='my-20 relative'>
            ...
            <div className='absolute top-[10%] left-[5%] md:top-[15%] md:left-[10%] md:flex-row flex flex-col gap-10  md:gap-32 justify-center items-center'>
                <div className='md:w-[741px] md:h-[418px] w-[200px] h-[400px]'>
                    <h2 className='font-[500] text-[12px] md:text-[54px] leading-[66.42px] mb-10'>
                        Lorem Ipsum dolor sit consectetur
                    </h2>
                    <span className='font-[300] text-[10px] md:text-[20px] leading-[20px] md:leading-[34px]'>
                ...
                <div className='md:w-[400px] md:h-[500px] w-[300px] h-[400px] bg-[#fff] rounded-[14px] px-2 shadow-lg border md:my-0 my-12'>
