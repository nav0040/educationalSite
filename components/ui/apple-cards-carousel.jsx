...
export const Carousel = ({
    ...
    return (
        (<CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
            ...
            <div className="flex justify-end gap-2 mr-28">
                    <button
                        className="relative z-40 h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center disabled:opacity-50"
                        onClick={scrollLeft}
                        disabled={!canScrollLeft}>
                        <RiPlayReverseFill className="h-6 w-6 text-black" />
                    </button>
                    <button
                        className="relative z-40 h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center disabled:opacity-50"
                        onClick={scrollRight}
            ...
            <div className="">
                <Image
                    ...
                    {...rest} />
                            ...
                            <div  className='absolute inset-0 top-[60%] z-20 text-white p-4 px-10 text-start'>
                                <span className="font-[300] text-[16px] leading-[24px]">21 March 2023</span>
                                <h3 className="font-[500] text-[22px] leading-[40.4px]">
                                dictumst. Fusce non venenatis velit. Proin luctus malesuada mauris vitae mattis
                                </h3>
                                <span className="font-[300] text-[16px] leading-[30px]">Read More</span>
                            </div>
